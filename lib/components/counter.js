...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "my-custom-element {\n  display: block;\n  background-color: blue;\n}\nmy-custom-element button {\n  color: yellow;\n}", "",{"version":3,"sources":["webpack://./src/components/style.scss"],"names":[],"mappings":"AAAA;EACE,cAAA;EACA,sBAAA;AACF;AACE;EACE,aAAA;AACJ","sourcesContent":["my-custom-element {\n  display: block;\n  background-color: blue;\n\n  button {\n    color: yellow;\n  }\n}"],"sourceRoot":""}]);
// Exports
...
/* harmony import */ var _core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../core */ "./src/core/index.tsx");


class MyComponent extends _core__WEBPACK_IMPORTED_MODULE_1__.WC {
    constructor() {
        super(...arguments);
        this.styles = [_style_scss__WEBPACK_IMPORTED_MODULE_0__["default"]];
        this.$count = 0;
    }
    template() {
        return ((0,_core__WEBPACK_IMPORTED_MODULE_1__.h)(_core__WEBPACK_IMPORTED_MODULE_1__.Fragment, null,
            (0,_core__WEBPACK_IMPORTED_MODULE_1__.h)("h1", null, this.$count),
            (0,_core__WEBPACK_IMPORTED_MODULE_1__.h)("button", { onClick: this.inc }, "+ Inc"),
            (0,_core__WEBPACK_IMPORTED_MODULE_1__.h)("button", { onClick: this.dec }, "- Dec")));
    }
    inc() {
        this.$count++;
    }
