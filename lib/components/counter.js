    ...
    customElements.define(componentName, class extends HTMLElement {
        constructor() {
            ...
            const el = this.buildEl((0,nano_jsx_lib_core__WEBPACK_IMPORTED_MODULE_0__._render)({
                component,
                props: Object.assign({ ref: (r) => (ref = r), children: Array.from(this.childNodes).map(c => (0,nano_jsx_lib_core__WEBPACK_IMPORTED_MODULE_0__.render)(c)) }, (this.getInitialProps() || {}))
            }));
            this.component = ref;
...
class Counter extends ___WEBPACK_IMPORTED_MODULE_0__.WC {
    constructor() {
        super(...arguments);
        this.data = this.$({
    ...
    render() {
        ...
        return ((0,___WEBPACK_IMPORTED_MODULE_0__.h)(___WEBPACK_IMPORTED_MODULE_0__.Fragment, null,
            (0,___WEBPACK_IMPORTED_MODULE_0__.h)("h1", null, this.data.count),
            (0,___WEBPACK_IMPORTED_MODULE_0__.h)("button", { onclick: () => this.data.count-- }, "Dec"),
            (0,___WEBPACK_IMPORTED_MODULE_0__.h)("button", { onclick: () => this.data.count++ }, "Inc"),
            this.props.children));
    }
}
